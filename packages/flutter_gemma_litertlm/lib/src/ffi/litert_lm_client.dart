...
class LiteRtLmFfiClient {
  ...
  Stream<String> _doSendMessageStreamRawOn(
    ...
    // ココメシ vendorパッチ: 画像の実効解像度を決めるvisual token budgetを反映
    final visualBudget = litertLmVisualTokenBudget;
    if (visualBudget != null) {
      b.litert_lm_conversation_optional_args_set_visual_token_budget(
        optionalArgs,
        visualBudget,
      );
    }
